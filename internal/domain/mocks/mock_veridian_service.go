...
// IssueMagicLinkForHub mocks base method.
func (m *MockVeridianService) IssueMagicLinkForHub(arg0 context.Context, arg1 domain.IssueMagicLinkInput) (*domain.IssueMagicLinkResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IssueMagicLinkForHub", arg0, arg1)
	ret0, _ := ret[0].(*domain.IssueMagicLinkResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IssueMagicLinkForHub indicates an expected call of IssueMagicLinkForHub.
func (mr *MockVeridianServiceMockRecorder) IssueMagicLinkForHub(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IssueMagicLinkForHub", reflect.TypeOf((*MockVeridianService)(nil).IssueMagicLinkForHub), arg0, arg1)
}
