...
// CreateAutoLoginSession mocks base method.
func (m *MockUserServiceInterface) CreateAutoLoginSession(arg0 context.Context, arg1 string) (*domain.AuthResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAutoLoginSession", arg0, arg1)
	ret0, _ := ret[0].(*domain.AuthResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateAutoLoginSession indicates an expected call of CreateAutoLoginSession.
func (mr *MockUserServiceInterfaceMockRecorder) CreateAutoLoginSession(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAutoLoginSession", reflect.TypeOf((*MockUserServiceInterface)(nil).CreateAutoLoginSession), arg0, arg1)
}
