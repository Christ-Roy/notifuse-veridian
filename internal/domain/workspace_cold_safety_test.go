...
func TestColdSafetyPolicyRejectsMalformedProviderClasses(t *testing.T) {
	settings := completeColdSafetySettings()
	settings.VeridianProviderClassRates = map[string]float64{" Unknown ": 1}
	settings.VeridianProviderClassDailyCap = map[string]int{" Unknown ": 1}
